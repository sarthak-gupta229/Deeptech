...
const ProgramHighlights = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full bg-white pt-28 pb-16 px-4 sm:px-6 lg:px-8 relative lg:h-[230vh]"
    >
      <div className="lg:sticky lg:top-0 lg:h-screen lg:flex lg:items-center">
        <div className="max-w-7xl w-full mx-auto flex flex-col lg:flex-row gap-8 lg:gap-16 items-start">
